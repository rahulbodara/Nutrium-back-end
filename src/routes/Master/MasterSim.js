...
const appointment_status = require('../../model/Masters/AppoinmentStatus');
const AppointmentConsultation = require('../../model/Masters/AppointmentConsultation');
const BirthdaySystem = require('../../model/Masters/BirthdaySystem');
const BloodGroup = require('../../model/Masters/BloodGroup');
const BowelMovement = require('../../model/Masters/BowelMovement');
const ClientFilter = require('../../model/Masters/ClientFilter');
const ClinicalGoals = require('../../model/Masters/ClinicalGoals');
const Country = require('../../model/Masters/Country');
const DietaryDatabaseFilter = require('../../model/Masters/DietaryDatabaseFilter');
const Diseases = require('../../model/Masters/Diseases');
const FileCategory = require('../../model/Masters/FileCategory');
const FoodDatabaseFilter = require('../../model/Masters/FoodDatabaseFilter');
const FoodFilter = require('../../model/Masters/FoodFilter');
const FoodGroup = require('../../model/Masters/FoodGroup');
const FoodIntolerances = require('../../model/Masters/FoodIntolerances');
const Gender = require('../../model/Masters/Gender');
const GestationType = require('../../model/Masters/GestationType');
const GoalType = require('../../model/Masters/GoalType');
const Language = require('../../model/Masters/Language');
const MeritialStatus = require('../../model/Masters/MeritialStatus');
const NutritionalDeficiencies = require('../../model/Masters/NutritionalDeficiencies');
const NutriumProfession = require('../../model/Masters/NutriumProfession');
const PregnancyType = require('../../model/Masters/PregnancyType');
const Race = require('../../model/Masters/Race');
const RecipeCategory = require('../../model/Masters/RecipeCategory');
const SleepQuality = require('../../model/Masters/SleepQuality');
const Smoker = require('../../model/Masters/Smoker');
const TemplateFilter = require('../../model/Masters/TemplateFilter');
const TimeZone = require('../../model/Masters/TimeZones');
const TypeOFDiet = require('../../model/Masters/TypeOfDiet');
