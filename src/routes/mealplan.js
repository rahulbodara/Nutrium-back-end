...
const { createMealPlan, getMealPlan, updateMealPlan, deleteMealPlan, deleteMealPlanObject, deleteFoods, deleteParticularFood, createMealData, getMealData, getAllMealPlan } = require('../controller/mealplan');
...
router.get('/getAllMealPlan', isAuthenticated, getAllMealPlan)
